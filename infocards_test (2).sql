...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 13, 2020 at 06:20 AM
...
CREATE TABLE IF NOT EXISTS `tbl_images` (
  ...
  `isDeleted` tinyint(4) NOT NULL DEFAULT 0,
  `totalDownloads` int(11) DEFAULT NULL,
  `createdAt` timestamp NOT NULL DEFAULT current_timestamp(),
  `updatedAt` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`imageId`)
...
(10, 'srikanthpachipulusu123@gmail.com', '$2y$10$QSF7pWHbkSOyQBfvEpJ.1.efGXrIMU2mi./R.nclFMHPMs9b/2EO6', 'Srikanth', '7893074019', 3, NULL, 0, NULL, '2020-02-13 03:19:52', NULL, NULL);
